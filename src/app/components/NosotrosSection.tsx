            ...
            <div className="container mx-auto max-w-7xl">
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    <div className={`transform transition-all duration-1000 ${
                        ...
                        <div className="mb-8">
                            <span className={`inline-block px-4 py-2 rounded-full text-sm font-semibold tracking-wide mb-6 transform transition-all duration-700 delay-200 ${
                                isVisible ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'
                            }`}
                                style={{ backgroundColor: '#E4DAAE', color: '#28110E' }}>
                                Nuestra Historia
                            </span>
                            <h2 className={`text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black mb-8 leading-tight transform transition-all duration-1000 delay-300 ${
                        ...
                        <div className={`space-y-6 text-base sm:text-lg text-gray-600 leading-relaxed transform transition-all duration-1000 delay-500 ${
                            isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'
                        }`}>
                            <p>
                        ...
                        <div className={`mt-12 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 transform transition-all duration-1000 delay-700 ${
                            isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'
                        }`}>
                    ...
                    <div className={`relative transform transition-all duration-1200 delay-300 ${
                        ...
                        <div className="grid grid-cols-2 gap-4 sm:gap-6">
                            {/* Video 1 */}
                            <div className={`transform transition-all duration-1000 delay-600 hover:scale-105 ${
                            ...
                            {/* Video 2 */}
                            <div className={`transform transition-all duration-1000 delay-800 hover:scale-105 mt-8 sm:mt-12 ${
                                isVisible ? 'translate-y-0 opacity-100' : 'translate-y-12 opacity-0'
                            }`}>
                                <video
                                    className="w-full h-64 sm:h-80 md:h-96 object-cover rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-500"
                        ...
                        <div className={`absolute -bottom-4 -right-4 sm:-bottom-6 sm:-right-6 w-24 h-24 sm:w-32 sm:h-32 rounded-2xl shadow-2xl transform transition-all duration-1000 delay-1000 hover:scale-110 hover:rotate-3 ${
