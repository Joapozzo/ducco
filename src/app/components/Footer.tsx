import { Instagram, Facebook, Twitter, Users, Truck, Shield, Headphones } from 'lucide-react';
            ...
            <div className="container mx-auto max-w-7xl">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
                    ...
                    <div className="md:col-span-2">
                        <div className="text-4xl font-black mb-6" style={{ color: '#F24026' }}>
                            DUCCÓ
                        </div>
                        ...
                        <p className="text-gray-400 text-lg leading-relaxed mb-8">
                            Más de 35 años transformando hogares con muebles de calidad excepcional.
                            Cada pieza cuenta una historia, cada espacio refleja una personalidad única.
                        </p>

                        {/* Redes sociales */}
                        <div className="flex space-x-4">
                            <a href="#" className="p-4 bg-gray-700 rounded-xl text-gray-400 hover:text-white hover:bg-gray-600 transition-all duration-300">
                    ...
                    {/* Enlaces rápidos */}
                    <div>
                        <h4 className="text-white font-bold text-xl mb-6">Enlaces Rápidos</h4>
                        <ul className="space-y-4">
                            {['Inicio', 'Nosotros', 'Destacados', 'Catálogo', 'Ofertas', 'Galería', 'Contacto'].map((link) => (
                                <li key={link}>
                                    <a
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-gray-400">
                            ...
                            <li className="flex items-center space-x-3">
                                <Headphones className="w-5 h-5" style={{ color: '#F24026' }} />
